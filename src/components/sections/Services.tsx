    ...
    <section id="services" className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="mb-12 rounded-2xl overflow-hidden border border-[var(--color-border)] shadow-[var(--shadow-card)]"
        >
          <Image
        ...
        >
          {SERVICES.map((service, i) => {
            ...
            return (
              ...
              >
                <div
                  className="w-12 h-12 rounded-xl bg-[var(--color-primary)]/10 flex items-center justify-center mb-4
